...
namespace gfx
{
    class IApplication
    {
        ...
        private:
            ...
            virtual bool InternOnStartup();         //am Anfang aufgerufen
            virtual bool InternOnShutdown();        //am Ende aufgerufen
            virtual bool InternOnCreateTextures();  //am Anfang, nach InternOnStartup
            virtual bool InternOnReleaseTextures(); //am Ende, vor InternOnShutdown
            virtual bool InternOnCreateMeshes();    
            virtual bool InternOnReleaseMeshes();
            virtual bool InternOnResize(int _Width, int _Height);   //wenn sich Fenster veraendert
            virtual bool InternOnKeyEvent(unsigned int _Key, bool _IsKeyDown, bool _IsAltDown); //wenn Taste gedrückt wird
            virtual bool InternOnMouseEvent(int _X, int _Y, int _Button, bool _IsButtonDown, bool _IsDoubleClick, int _WheelDelta); //wenn Mouse gedrückt wird
            virtual bool InternOnUpdate();
            virtual bool InternOnFrame(); //Ausgabe
    };
} // namespace gfx
...
namespace gfx
{
    ...
    float* MulMatrix(const float* _pLeftMatrix, const float* _pRightMatrix, float* _pResultMatrix); //result = Ergebnis wird dort gespeichert
